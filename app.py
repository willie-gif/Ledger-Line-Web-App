...
def validate_password_strength(password):
    """Requires a mix of letters, numbers, and at least one special character —
    ...
    if not SPECIAL_CHARS_RE.search(password):
        return False, "Password needs at least one special character (e.g. ! @ # $ % &)."
    return True, None
    ...
    with tab_signup:
        with st.form("signup_form"):
            ...
            new_password = st.text_input("Password", type="password", key="signup_password",
                                          help="At least 8 characters, with a mix of letters, numbers, and a special character (e.g. ! @ # $).")
